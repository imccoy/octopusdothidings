...
function createCell(document           , color                  , clickHandler            )                                                {
...
function runProgram(divs            , program               , index        , retry            , nextLevel            ) {
...
function waitForSolution(divs            , solution       , retry            , nextLevel            ) {
...
function showIntroMessage(cell              )        {
